...
\begin{assumption}
\label{ass:lipschitz}
The stage cost $\ell(u,y)$ and the constraint function $h(y)$ are convex and Lipschitz on the compact sets of interest, and the tractable Wasserstein DR-DeePC reformulation of \eqref{eq:drdeepc-abstract} is feasible for all $\epsilon \in [\epsilon_{\min},\epsilon_{\max}]$ considered by the adaptive law.
\end{assumption}
